...
?>
<li style="margin:0px; cursor:pointer;" onclick="cargaSection('<?php echo $f_m["men_id"]; ?>','<?php echo $f_s["submen_id"]; ?>');"><?php echo $f_s["submen_tit"]; ?></li>
<?php
					}
					echo "</ul>";
				}
